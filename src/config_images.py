...
parser.add_argument(
    ...
    type=int,
    default=100,
    help="number features to generate per class",
)
parser.add_argument(
    "--gzsl",
    action="store_true",
...
parser.add_argument(
    ...
    type=int,
    default=4096,
    help="size of the hidden units in generator",
)
parser.add_argument(
    "--ndh",
    type=int,
    default=1024,
    help="size of the hidden units in discriminator",
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=int,
    default=5,
    help="critic iteration, following WGAN-GP",
)
parser.add_argument(
    "--lambda1",
    type=float,
...
parser.add_argument(
    ...
    type=float,
    default=1.0,
    help="recons_weight for decoder",
)
